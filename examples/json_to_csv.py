"""Convert sweep JSON output into a CSV file."""
...
from geoapify_places import export_to_csv


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Convert Geoapify sweep JSON output into a CSV file."
    )
    parser.add_argument(
        "input_json",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Destination .csv path (defaults to replacing .json with .csv).",
    )
...
def main() -> None:
    ...
    output = args.output or args.input_json.with_suffix(".csv")
